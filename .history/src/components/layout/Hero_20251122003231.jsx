...
const Hero = () => {
  return (
    <section
      className="container rounded-xl relative h-96 bg-no-repeat mt-10 overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 md:px-0 space-y-4 text-center">
        ...
        >
          Discover our collection of beautiful, high-quality plants to liven up your space and
          purify your air.
        </motion.h2>
