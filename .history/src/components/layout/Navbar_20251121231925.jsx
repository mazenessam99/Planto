      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            onClick={() => setMenuOpen(false)} // اضغط على الخلفية يقفل المينو
          >
            {/* Drawer */}
            <motion.div
              ...
              animate={{ x: 0 }}
              exit={{ x: "-100%" }}
              transition={{ type: "ease-in-ou", duration: 0.4 }}
              onClick={(e) => e.stopPropagation()} // منع إغلاق عند الضغط داخل الدروار
            >
              {/* Close */}
