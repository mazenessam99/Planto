...
const Subscribtion = () => {
    return (
        <section className="container p-10 rounded-xl flex flex-col items-center justify-between gap-4 bg-primary/20">
            ...
            <form className="flex flex-col sm:flex-row w-full max-w-md gap-2 mt-4 ">
                <input placeholder="your-email@example.com" type="email" className="bg-white h-12  px-4 py-2 rounded-xl border border-primary/30 w-80 outline-0"/>
