...
>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 md:px-0 space-y-4">
            ...
            <h2 className=" text-white/90 text-sm md:text-base lg:text-lg max-w- font-normal">Discover our collection of beautiful, high-quality plants to liven up your space and purify your air.</h2>
